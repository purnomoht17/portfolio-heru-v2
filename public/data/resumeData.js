...
export const resumeData = {
  experience: [
      ...
      id: 1,
      period: "2025",
      position: "Divisi Logistik Pergudangan - Pekan Raya Jakarta (2025)",
    ...
    },
    {
      id: 4,
      period: "2024 - 2025",
      position: "Koordinator Divisi Akomodasi - Bakti Sosial Nawasena 2025",
      company: "BEM Universitas Tarumanagara",
      location: "Jakarta Barat",
    ...
    },
    {
      id: 5,
      period: "2024 - 2025",
      position: "Anggota Divisi Perlengkapan - UKM Open House 2025",
      company: "BEM Universitas Tarumanagara",
      location: "Jakarta Barat",
  ...
  education: [
    {
      ...
      description: "Mahasiswa aktif semester 5 dengan fokus pada pengembangan backend, arsitektur sistem, dan manajemen basis data."
    },
    {
      id: 2,
      period: "2020 - 2023",
      ...
      description: "Menyelesaikan pendidikan menengah dengan jurusan Ilmu Pengetahuan Alam (IPA), yang membentuk dasar logika, analisis, dan pemecahan masalah yang kini saya terapkan dalam pengembangan sistem dan pemrograman."
    }
  ],
  professionalSkills: [
    { id: 1, name: "Manajemen Waktu" },
    { id: 2, name: "Kemampuan Adaptabilitas" },
    { id: 3, name: "Kolaborasi Tim" },
    { id: 4, name: "Kepemimpinan" },
  ],
  languages: [
